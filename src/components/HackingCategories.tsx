...
const HackingCategories: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-8 text-center text-green-500">Hacking Categories</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {categories.map((category) => (
          <div
            key={category.id}
            className="bg-gray-800 p-6 rounded-lg shadow-lg cursor-pointer transform transition duration-300 hover:scale-105"
            onClick={() => setSelectedCategory(category)}
          >
            <div className="flex items-center justify-center mb-4">
              {category.icon}
            </div>
            <h2 className="text-xl font-semibold mb-2 text-center text-green-400">{category.title}</h2>
      ...
      {selectedCategory && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 p-8 rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            <h2 className="text-3xl font-bold mb-4 text-green-500">{selectedCategory.title}</h2>
            <p className="text-gray-300 mb-6">{selectedCategory.description}</p>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <h3 className="text-xl font-semibold mb-2 text-red-400">Common Attacks</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-blue-400">Defense Strategies</h3>
                <ul className="list-disc list-inside text-gray-300">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-yellow-400">Popular Tools</h3>
                <ul className="list-disc list-inside text-gray-300">
            ...
            <button
              className="mt-8 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition duration-300"
