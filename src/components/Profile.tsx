        ...
        <div className="md:w-1/3 bg-gray-700 p-4">
          ...
          <div className="mt-4 text-gray-300">
            <p className="flex items-center mb-2">
              <MapPin size={18} className="mr-2" /> {profile.location}
            </p>
            <p className="flex items-center mb-2">
              <Briefcase size={18} className="mr-2" /> {profile.occupation}
            </p>
            <p className="flex items-center mb-2">
              <Calendar size={18} className="mr-2" /> Joined{" "}
              ...
              <div>
                ...
                <div className="flex flex-wrap">
                  {[
                    ...
                    <span
                      key={index}
                      className="bg-gray-700 text-green-400 rounded-full px-3 py-1 text-sm font-semibold mr-2 mb-2"
                    >
                      {skill}
                    </span>
                  ))}
